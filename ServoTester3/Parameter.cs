...
namespace ServoTester3
{
  public class Parameter
  {
    ...
    public struct _auto_setting
    {
      ...
      public _auto_setting()
      {
        this.FlagSetting = false;
        this.FlagStart = false;
        this.CurrentSpeed = 0;
        this.CurrentSeatingPoint = 0;
        this.CurrentFSpeed = 0;
        this.CurrentFAngle = 0;
      }
    }
    public _auto_setting AutoSetting = new _auto_setting();
    ...
    public struct _McFlag
    {
      ...
      public _McFlag()
      {
        this.b1Run = 0;   // #00
        this.b1Reset = 0;   // #01
        this.b1ControlFL = 0;   // #02     Forward/reverse distinction.
        this.LoosenAngle = 0;
        this.b1Lock = 0;   // #03     Run driver lock.
        this.b1Stopping = 0;   // #04     stop process start
        this.b1Multi_Mode = 0;   // #05     select mult mode
        this.b1Multi_Start = 0;   // #06     start mult sequence by IO or start switch
        this.b1TorqueUpCompleteOut = 0;   // #07
        this.b1FasteningCompleteOut = 0;   // #08
        this.b2LockCommand = 0;   // #09 #10 driver lock type
        this.b1Buzzer = 0;   // #11     buzzer control
        this.b1ReceiveModBusData = 0;   // #12
        this.b1InternalRun = 0;   // #13     driver start switch
        this.b1ExternalRun = 0;   // #14     IO start
        this.b1RunByMult = 0;   // #15     Run inside Multisequence start..
        this.b1JabCompliteIoOut = 0;   // #16     Flag_JabCompliteIOOut io output..
        this.b1FirmwareUpdate = 0;   // #17 
        this.b1CountStartSensorSignalResult = 0;   // #18 A signal considering the delay time of the sensor input.
        this.b1ParaStartInitialize = 0;   // #19
        this.b1ParaInitialized = 0;   // #20
        this.b1SaveDrvModel = 0;   // #21
        this.b1OneTimeExecute = 0;   // #22 Executed only once during initial booting.
        this.b1ResetSystem = 0;   // #23 reset System.
        this.b1SendHostCTqNotComplete = 0;   // #24 Step definition that increases c tq value..
        this.b1FasteningStopAlarm = 0;   // #25 Stop before fastening after start..
        this.b1FoundEngagingTorque = 0;   // #26
        this.b1Reached_LITTLE_REWIND = 0;   // #27 if error appier display torque.
        this.b1DriverParaInit = 0;   // #28 driver parameter init request
        this.b1DriverSaveParaData = 0;   // #29
        this.b1EnableCyclic = 0;   // #30 enable cyclic
        this.b1Ready = 0;
      }
    }
    public _McFlag McFlag = new _McFlag();
    ...
    public _DriverInfoStruct inDriverInfo = new _DriverInfoStruct(0);
    ...
    public void InitParameter(ushort u16MC_DRIVER_MODEL_)
    {
      ...
      // Para.dft.u16MC_SCREW_TYPE = 0; Mc.Para.min.u16MC_SCREW_TYPE = 0; Mc.Para.max.u16MC_SCREW_TYPE = 0x7fff;              //SET[9] :  
